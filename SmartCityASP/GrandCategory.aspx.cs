...
{
    public partial class GrandCategory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                lblGCId.Text = "Grand CategoryID : " + objGCBAL.GetMaxId();
                BindGridView();
            }
        }
        ...
        protected void gvGCDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (commandName == "EditRow")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    lblGCId.Text = "Grand CategoryID : " + ds.Tables[0].Rows[0]["PK_ID"].ToString();
                    txtGName_E.Text = ds.Tables[0].Rows[0]["GName_E"].ToString();
                    txtGName_M.Text = ds.Tables[0].Rows[0]["GName_M"].ToString();
                }
            }
            else
            {
