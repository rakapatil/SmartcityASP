<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubChildCategory.aspx.cs" MasterPageFile="~/UserSite.Master" Title="Sub ChildCategory" Inherits="SmartCityASP.SubChildCategory" %>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>Add Sub ChildCategory
               
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li class="active">Add Sub ChildCategory</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Add Sub ChildCategory</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlParentCategory" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlParentCategory_SelectedIndexChanged" CssClass="form-control select2" required="required" Style="width: 100%;">
                                            </asp:DropDownList>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvCCDetails" runat="server" AutoGenerateColumns="false" OnRowCommand="gvCCDetails_RowCommand" AllowPaging="true" OnPageIndexChanging="gvCCDetails_PageIndexChanging" PageSize="10" DataKeyNames="PK_ID" class="table table-bordered table-striped">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Name_M" DataField="SCName_M" />
                                        <asp:BoundField HeaderText="Name_E" DataField="SCName_E" />
                                        <asp:BoundField HeaderText="ChildCategoryId" DataField="CFK_ID" />
