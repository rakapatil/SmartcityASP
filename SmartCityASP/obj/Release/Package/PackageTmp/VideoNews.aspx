<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoNews.aspx.cs" MasterPageFile="~/UserSite.Master" Title="Video News | SCS" Inherits="SmartCityASP.VideoNews" %>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>Add Video News Details
               
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li class="active">Add Video News Details</li>
                    </ol>
                </section>
                                ...
                                <div role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtVideoName" runat="server" class="form-control" required="required" PlaceHolder="Enter Video Name"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <label for="lblVideoPath">Enter Video Path *</label>
                                            <asp:TextBox ID="txtVideoPath" runat="server" class="form-control" required="required" PlaceHolder="Enter Video LINK"></asp:TextBox>
                                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="gvPCDetails" runat="server" AutoGenerateColumns="false" OnRowCommand="gvPCDetails_RowCommand" AllowPaging="true" OnPageIndexChanging="gvPCDetails_PageIndexChanging" PageSize="10" DataKeyNames="NewsId" class="table table-bordered table-striped">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="VideoName" DataField="VideoName" />
                                        <asp:BoundField HeaderText="VideoLink" DataField="VideoPath" />
