<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImageWithText.aspx.cs" MasterPageFile="~/UserSite.Master" Title="Image With Text | SCS" Inherits="SmartCityASP.ImageWithText" %>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>Add Image With Text News Details
               
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li class="active">Add Image With Text News Details</li>
                    </ol>
                </section>
