<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNotifications.aspx.cs" MasterPageFile="~/UserSite.Master" Title="Notifications" Inherits="SmartCityASP.AddNotifications" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add Notifications Details
               
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">Add Notificatons</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Fill Notifications Information</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="lblRegId">Notifications ID : 104</label>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="lblCounter">Enter Counter</label>
                                <input type="number" class="form-control" id="txtCounter" required="required" placeholder="Enter Counter as Number">
                            </div>
